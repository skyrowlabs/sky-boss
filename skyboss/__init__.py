...
from skyboss.helpers import INVOCATION, PROJECT_ROOT, run_command  # noqa: E402
from skyboss.theme import (  # noqa: E402
    CLI_BRAND,
    CLI_DANGER,
    CLI_FAINT,
    CLI_LABEL,
...
from skyboss.canvas import ui as ui_cmd  # noqa: E402

# Aliased on import — `from skyboss.data import data` would rebind this package's
# `data` attribute from the module to the Command and shadow the module, the
# same gotcha `read` and `tools` dodge below.
from skyboss.data import data as data_cmd  # noqa: E402
from skyboss.read import read_ as read_cmd  # noqa: E402
...
from skyboss.agents import agents as agents_cmd  # noqa: E402
from skyboss.follow import follow as follow_cmd  # noqa: E402
from skyboss.history import history as history_cmd  # noqa: E402
from skyboss.jobs import job as job_cmd  # noqa: E402
from skyboss.mcp import mcp as mcp_cmd  # noqa: E402
from skyboss.rollcall import roll_call as roll_call_cmd  # noqa: E402
from skyboss.schedule import schedule as schedule_cmd  # noqa: E402
