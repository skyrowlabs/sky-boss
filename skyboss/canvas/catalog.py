    ...
    return [
        {
            ...
            # What a tool is *about*. Many, where `group` is one — the rail
            # sorts by the group and filters on these. Empty for anything that
            # is not a tagged saved command. See [[tools]] round 8.
            "tags": list(getattr(command, "sb_tags", ()) or ()),
