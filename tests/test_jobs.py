...
15 3 * * *    cd ~/src/jam.sense && ./jam report sentinel
# 03:45 is a scheduling constraint, not a preference.
45 3 * * *    cd ~/src/jam.sense && ./jam report integration
20 3,7,11,15,19,23 * * * cd ~/src/jam.sense && ./jam report release
0 0 * * 2     cd ~/src/jam.sense && ./jam report deps
"""
