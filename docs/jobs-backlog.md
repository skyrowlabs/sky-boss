...
| Unpushed / uncommitted work audit | D | Across `~/skyrow.labs`; catches work living only on one disk |
...
| Lab temp/humidity thresholds | D | Near `node-01` — 4x 145W in a residential room |
